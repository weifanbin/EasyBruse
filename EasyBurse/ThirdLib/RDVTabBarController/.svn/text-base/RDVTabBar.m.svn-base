...
- (void)layoutSubviews {
    ...
    [[self line] setFrame:CGRectMake(0, 0, frameSize.width, 1)];
...
- (void)setTranslucent:(BOOL)translucent {
    ...
    [_backgroundView setBackgroundColor:[UIColor colorWithRed:249/255.0
                                                        green:249/255.0
                                                         blue:249/255.0
                                                        alpha:alpha]];
    [_line setBackgroundColor:[UIColor colorWithRed:216/255.0
                                              green:216/255.0
                                               blue:216/255.0 alpha:alpha]];
}
